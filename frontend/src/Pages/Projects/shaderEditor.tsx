...
const StyledShaderViewer = styled(ShaderViewer)`
	grid-area: view;
	max-height: 500px;
`;
...
const Test = styled.div`
	height: 100vh;
	display: grid;
	grid-template-areas: 'view editor' 'info editor';
...
const shaderEditor = (props: Props) => {
	return (
		<Test>
			<StyledShaderViewer vertexShader="vertex-1.glsl" fragmentShader="fragment-3.glsl" />
			<StyledEditor>
				<SyntaxHighlighter
					language={'glsl'}
					style={tomorrow}
