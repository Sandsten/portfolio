...
const homePage = () => {
	...
	return (
		<StyledHomePage>
			<CSSTransition in={shouldAnimate} appear={shouldAnimate} classNames="fade" timeout={500}>
				<div>
					...
					<Paragraph>
						...
						at <StyledA href="https://kth.se">Kungliga Tekniska Högskolan</StyledA>. Which sparked
						my interest for programming and graphics.
					</Paragraph>
